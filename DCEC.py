...
class ClusteringLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        self.input_spec = InputSpec(dtype=K.floatx(), shape=(None, input_dim))  # todo : check shape of input_dim
...
class DCEC(object):
    ...
    def pretrain(self, x, batch_size=256, epochs=EPOCHS, optimizer='adam', save_dir='results/temp'):
        print('Pretraining.....')
    ...
    def predict(self, x):
        q, _ = self.model.predict(x, verbose=0)  # class
        return q.argmax(1)
    ...
    def fit(self, x, y=None, batch_size=256, max_iter=2e4, tol=1e-3,
        ...
        if not self.pretrained and cae_weights is None:
            print(f'pretraining CAE using default hyper-parameters with adam; epochs={EPOCHS}')
        ...
        # set weights with centroids of KMeans
...
if __name__ == '__main__':
    ...
    # load dataset
    if args.dataset == 'mnist' or args.dataset == 'mnist-test':
    ...
    dcec.fit(x, y=y, tol=args.tol, max_iter=args.maxiter,
